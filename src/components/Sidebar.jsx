...
const NAV_BASE = [
  {
    ...
    items: [
      ...
      { to: '/metrics',           label: 'Metrics',           icon: BarChart2,       color: ['#EDE9FE', '#7C3AED'],
        baseRoles: ['Admin','Sales Ops','SalesHead','VH','Agent'],
        ...
        <div className="px-4 py-4 border-t border-ios-separator">
          <div className="flex items-center gap-3">
            <button
              ...
              className="relative w-9 h-9 rounded-full overflow-hidden group focus:outline-none shrink-0"
              title="Edit profile"
            >
              {user.photoUrl
